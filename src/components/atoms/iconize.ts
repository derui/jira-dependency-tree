...
const Icons = {
  ...
  "door-exit": "before:[mask-image:url(/svg/tabler-icons/door-exit.svg)]",
  ...
  "circle-x": "before:[mask-image:url(/svg/tabler-icons/circle-x.svg)]",
  "circle-check": "before:[mask-image:url(/svg/tabler-icons/circle-check.svg)]",
